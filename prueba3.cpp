...
void impTablero()//string tablero[8][8])
{
    ...
    while (cont<7)
    {
        for (int i=1;i<=4;i++)    // dibujando l�mite superior
        {
            if (i%4!=0)
            {
                cout<<"\315";
    ...
    while (cont<7)
    {
        for (int i=1;i<=4;i++)    // dibujando l�mite inferior
        {
            if (i%4!=0)
            {
                cout<<"\315";
...
void iniciaTablero()
{
    ...
    for (int i=0;i<8;i++)
    {
        tablero[i][1]=piezas1[0];   //ubicaci�n de peones
        tablero[i][6]=piezas2[0];
    }

    tablero[0][0]=piezas1[1];
    tablero[1][0]=piezas1[2];    //ubicaci�n otras piezas jugador 1
    ...
    tablero[3][7]=piezas2[4];    //ubicaci�n otras piezas jugador 2
    ...
    for (int i=0;i<8;i++)
    {
        for (int j=0;j<8;j++)
        {
            if (tablero[i][j]=="\0")    //Dibujando espacitos vac�os
            {
                tablero[i][j]="  ";
            }
        }
...
int main ()
{
    ...
    do{
    cout<<"Ingrese ? (Acerca de) y nombre de archivo: "<<endl;
    cin>>respuesta;
    cout<<endl;
    ...
    if(respuesta=="?"){
    ...
    else if(respuesta == "partida1.dat"){
	    ...
	    do
	    {
	        cout << "Se esta jugando el turno #"<<cont<<endl;
	        if (turno%2==0)
	        {
	            do {
	                file<<cont<<". ";
